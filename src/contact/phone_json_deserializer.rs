...
impl PhoneJsonDeserializer {
    ...
    ///
    /// Returns [`ContactCodecError::InvalidJson`] unless `value` is a JSON string or `null`,
    /// and [`ContactCodecError::InvalidPhone`] when that string has an unsupported phone form.
