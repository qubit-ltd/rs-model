...
/// # Parameters
///
/// * `id` - Identifier to compare with the default value.
///
/// # Returns
///
/// `true` when `id` is the default identifier.
#[must_use]
fn is_default_id(id: &Id) -> bool {
    *id == Id::default()
}
...
struct SessionWire<'a> {
    #[serde(skip_serializing_if = "is_default_id")]
    id: Id,
