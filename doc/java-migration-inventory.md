...
- **available in qubit-mixin**: a matching public type is already exported by
  ...
  adopts it.
- **available in qubit-model**: a matching public type is already exported by
  `qubit-model`.
- **planned**: the type has not yet been migrated to `qubit-model`.
- **blocked: upload Attachment closure**: the source model contains an
  `Attachment` field and must wait for the separately scheduled upload model
  closure rather than substitute an ID or untyped placeholder.

Direct migration dependencies are synchronized from both ordinary `import`
and `import static` declarations by
`scripts/synchronize_java_migration_dependencies.py`. Static imports resolve
to their owning source-inventory type, including public nested types.
...
| --- | --- | --- | --- | --- |
| `ltd.qubit.commons.error.BeanValidationFailedException` | `qubit_model::ModelError::ValidationFailed` | ModelError validation variant | - | available in qubit-model |
...
| `ltd.qubit.commons.mixin.InfoWithEntity` | `qubit_mixin::InfoWithEntity` | struct (Java class) | ltd.qubit.commons.util.NameBuilder | available in qubit-mixin |
...
| `ltd.qubit.model.claim.enterprise.EnterpriseClaim` | `qubit_model::claim::enterprise::EnterpriseClaim` | struct (Java class) | ltd.qubit.commons.mixin.Creatable, ltd.qubit.commons.mixin.Identifiable, ltd.qubit.commons.mixin.Modifiable, ltd.qubit.model.claim.AccidentReason, ltd.qubit.model.claim.InsuredStatus, ltd.qubit.model.claim.QuickCompensationState, ltd.qubit.model.commons.Kinship, ltd.qubit.model.order.Client, ltd.qubit.model.product.Product, ltd.qubit.model.upload.Attachment, ltd.qubit.model.claim.enterprise.EnterpriseClaimStatus | planned |
...
| `ltd.qubit.model.commons.Category` | `qubit_model::commons::Category` | struct (Java class) | ltd.qubit.commons.mixin.Auditable, ltd.qubit.commons.mixin.Emptyful, ltd.qubit.commons.mixin.HasInfoWithEntity, ltd.qubit.commons.mixin.InfoWithEntity, ltd.qubit.commons.mixin.Normalizable, ltd.qubit.commons.mixin.Predefinable, ltd.qubit.commons.util.NameBuilder | planned |
...
| `ltd.qubit.model.commons.DictEntryInfo` | `qubit_model::commons::DictEntryInfo` | struct (Java class) | ltd.qubit.commons.mixin.Deletable, ltd.qubit.commons.mixin.Emptyful, ltd.qubit.commons.mixin.HasInfo, ltd.qubit.commons.mixin.Normalizable, ltd.qubit.model.commons.DictEntry | planned |
...
| `ltd.qubit.model.commons.Owners` | `qubit_model::commons::Owners` | struct (Java class) | ltd.qubit.commons.mixin.Emptyful, ltd.qubit.commons.mixin.Identifiable, ltd.qubit.commons.mixin.Normalizable, ltd.qubit.commons.util.NameBuilder | planned |
...
| `ltd.qubit.model.contact.PhoneCodec` | `qubit_model::contact::PhoneCodec` | struct (Java class) | ltd.qubit.model.contact.Phone | planned |
...
| `ltd.qubit.model.feedback.FeedbackProcessingRule` | `qubit_model::feedback::FeedbackProcessingRule` | struct (Java class) | ltd.qubit.model.feedback.FeedbackAction, ltd.qubit.model.feedback.FeedbackStatus | planned |
...
| `ltd.qubit.model.system.SettingXmlAdapter` | `qubit_model::system::SettingXmlAdapter` | struct (Java class) | ltd.qubit.model.system.Setting, ltd.qubit.model.system.SettingXmlAdapter.Adapted | planned |
